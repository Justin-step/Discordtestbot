...
module.exports.run = async (bot, message, args) => {
     ...
     if (!banUser) return message.reply("Sorry u kunt dit niet");

     if (banUser.permissions.has("MANAGE_MESSAGES")) return message.reply('Sorry kan persoon niet Verbannen');
     ...
     .setDescription(`Wilt u ${banUser} verbannen?`);
